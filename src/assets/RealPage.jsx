      ...
      <div className="account">
        <div className="accountTop">
          <div className="accountLogo">
            <div className="accountLogoHolder" style={{fontSize: "40px", display: "flex", alignItems:"center", justifyContent:"center"}}>
                {/* <FaInstagram /> */}
                <i>Instagram</i>
              {/* <img
                src="src/Components/Home/Instagram-logo-black-white-horizontal-png.png"
                alt=""
              /> */}
            </div>
          </div>
        ...
        <div className="logout">
          <div className="features">
            <div className="featuresWrapper">
              ...
              <div className="featuresIconTitle" onClick={logout} style={{cursor: "pointer"}}>Logout</div>
            </div>
          </div>
        </div>
      </div>
                ...
                <main className="makePostContainer">
                  ...
                  <div className="addCommentWrapper">
                    <input
                      ...
                      value={post}
                    />
                    <div className="sendIcon" onClick={()=>{sendPost(); toggle();}}>
                    <div><VscSend   /></div>
                    </div>
                  </div>
                </main> : null}
                  ...
                  <div className="postWrapper">
                    ...
                    <div className="postIconsContainer">
                      <div className="postIconWrapper">
                        ...
                        -1 ? (
                          <BiSolidLike onClick={() => likeButton(message, index)} />
                        ) : (
                          <AiOutlineLike onClick={() => likeButton(message, index)} />
                        )}
                        <p
